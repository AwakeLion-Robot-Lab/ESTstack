...
@misc{ahrs_davenport,
  ...
  year         = {2024},
  url          = {https://ahrs.readthedocs.io/en/latest/filters/davenport.html},
...
@misc{wang2022sfastlio,
  ...
  author       = {zlwang7},
  year         = {2022},
  url          = {https://github.com/zlwang7/S-FAST_LIO},
  note         = {Fast and efficient LiDAR-Inertial odometry with ikd-tree
